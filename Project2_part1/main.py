...
def run_softmax_on_MNIST(temp_parameter=1):
   ...
   # plot_cost_function_over_time(cost_function_history)
    ...
    updated_train_y, updated_test_y = update_y(train_y, test_y)

    # Compute test error with updated labels
    test_error = compute_test_error_mod3(test_x, updated_test_y, theta, temp_parameter)
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    theta, cost_function_history = softmax_regression(train_x, train_y_mod3, temp_parameter=1.0, alpha=0.3,
...
#plot_cost_function_over_time(cost_function_history)
pca_test_error = compute_test_error(test_pca, test_y, theta, temp_parameter=1.0)
print ("pca test error", pca_test_error)
...
#plot_cost_function_over_time(cost_function_history)
cubic_test_error = compute_test_error(test_cube, test_y, theta, temp_parameter=1.0)
print ("cubic test error", cubic_test_error)